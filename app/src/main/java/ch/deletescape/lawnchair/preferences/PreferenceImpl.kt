...
open class PreferenceImpl(context: Context) : IPreferenceProvider {
    ...
    override val showSearchPill by BooleanPref(FeatureFlags.KEY_SHOW_SEARCH_PILL, false)
    override val showDateOrWeather by BooleanPref(FeatureFlags.KEY_SHOW_DATE_OR_WEATHER, false)
